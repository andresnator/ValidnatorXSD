...
namespace LibData.Models
{
    ...
    public  class ErroresArchivos
    {
        ...
        [Key]
        public Guid ErroresArchivosId { get; set; }

        [Required(ErrorMessage = "Campo Requerido"), StringLength(2000, ErrorMessage = "Cantidad Máxima de 2000 caracteres")]
        [Column(TypeName = "varchar"), Display(Name = "Mensaje")]
