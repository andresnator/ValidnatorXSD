...
namespace LibData.Migrations
{
    public partial class tablaArchivoAlter : DbMigration
    {
        ...
        {
            AlterColumn("VLD.ArchivosProgramados", "UrlArchivoCargado", c => c.String(false, 400, unicode: false));
        ...
        public override void Down()
        {
            ...
            AlterColumn("VLD.ArchivosProgramados", "UrlArchivoCargado", c => c.String(false, 300, unicode: false));
        }
    }
}